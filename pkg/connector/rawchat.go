...
// This file re-implements chat calls with the replyTo lexicon fields that indigo's generated code doesn't include yet; delete once the SDK catches up.
...
func (e *logElemWithReply) UnmarshalJSON(b []byte) error {
	...
	if e.ConvoDefs_LogCreateMessage == nil {
		return nil
	}
	var extract struct {
...
func (e *messageElemWithReply) UnmarshalJSON(b []byte) error {
	...
	if e.ConvoDefs_MessageView == nil {
		return nil
	}
